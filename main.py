    """
    File Upload Service Mx94gl
    ==========================
    Open-source API service that authenticates data between clients and backends.
    ...
    APP_NAME    = "File Upload Service Mx94gl"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that authenticates data between clients and backends.")
